...
const StartStopBtn = (props) => {
    const classes = {
        turnOn: 'py-2 bg-green-400 rounded-lg border-[1px] border-green-600 w-[25vw] text-white text-2xl shadow-md hover:bg-green-300 transition',
        turnOff:
            'py-2 bg-red-400 rounded-lg border-[1px] border-red-600 w-[25vw] text-white text-2xl shadow-md hover:bg-red-300 transition'
    };
